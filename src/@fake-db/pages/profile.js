...
const data = {
  profileHeader: {
    fullName: 'PT. IMIP',
    location: 'Bahodopi',
    joiningDate: 'April 2009',
    designation: 'Pengolahan Nikel',
  ...
  profil: {
    about: [
      { property: 'Nama Perusahaan', value: 'PT. Indonesia Morowali Industrial Park', icon: 'mdi:account-outline' },
      { property: 'Alamat', value: 'Desa Fatufia', icon: 'mdi:check' },
      { property: 'Kantor Pusat', value: 'Developer', icon: 'mdi:star-outline' },
      { property: 'Status Pemodalan', value: 'USA', icon: 'mdi:flag-outline' },
      { property: 'Jenis Industri', value: 'English', icon: 'mdi:translate' },
      { property: 'Badan Hukum', value: '13.5k', icon: 'mdi:check' },
      { property: 'Tipe Jasa Pengolahan', value: '897', icon: 'mdi:account-outline' },
      { property: 'Nomor SK', value: '146', icon: 'mdi:view-grid-plus-outline' },
      { property: 'Nomor NIB', value: '146', icon: 'mdi:view-grid-plus-outline' },
      { property: 'Kode KBLI', value: '146', icon: 'mdi:view-grid-plus-outline' }
    ],
    contacts: [
      { property: 'Nomor HP', value: '(123) 456-7890', icon: 'mdi:phone-outline' },
      { property: 'Nomor Fax', value: 'john.doe', icon: 'mdi:message-outline' },
